...
namespace Game::Feature::Character::Animation
{
	...
	public:
		...
		static void UpdateMovementAnimationResolver(Engine::WorldSystem::Core::WorldCtx& ctx);

		static void UpdateAnimationArbiterSystem(Engine::WorldSystem::Core::WorldCtx& ctx);

		static void UpdateApplyFinalAnimationDecision(Engine::WorldSystem::Core::WorldCtx& ctx);
