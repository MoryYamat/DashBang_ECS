...
namespace Game::Collision::Data
{
	...
	inline Game::Collision::Data::GenericShape2D FromCircle(const glm::vec2& center, float radius)
	{
		return GenericShape2D{ Circle2D{ center, radius } };
	}

	inline Game::Collision::Data::GenericShape2D FromSector(const glm::vec2& center, const glm::vec2& dir, float angle, float radius)
	{
		return GenericShape2D{ Sector2D{ center, dir, angle, radius } };
	}

	inline Game::Collision::Data::GenericShape2D FromObb(const glm::vec2& center, const glm::vec2& halfExtents,
