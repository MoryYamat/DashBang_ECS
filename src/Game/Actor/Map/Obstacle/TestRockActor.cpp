...
TestRockActor::TestRockActor(ECS& ecs, Shader* shader)
{
	...
	//float rotRad = glm::radians(-logic.rotation);// OpenGL‚Í‰EŽèŒn‚¾‚ªClogic.rotation‚Í‰E‰ñ‚è‚Æ‚µ‚ÄŠi”[‚³‚ê‚Ä‚¢‚é‚Ì‚ÅC•„†‚ð”½“]
	float rotRad = -logic.rotation;// OpenGL‚Í‰EŽèŒn‚¾‚ªClogic.rotation‚Í‰E‰ñ‚è‚Æ‚µ‚ÄŠi”[‚³‚ê‚Ä‚¢‚é‚Ì‚ÅC•„†‚ð”½“]
