...
#include "Game/Combat/Private/Skill/MasterData/SkillCancelPhase.hpp" // SkillCancelBehavior
...
namespace Game::Combat::Skill::Data
{
	...
	{
		Game::Combat::Skill::Component::SkillExecutionEvent triggerTiming = Game::Combat::Skill::Component::SkillExecutionEvent::OnEnterActive; // スキルのトリガータイミング

		SkillLifetimeSpecDef lifetime; // ライフタイム仕様

		Game::Combat::Skill::Component::Attack2DShape shape; // 形状定義
		TrajectoryType trajectoryType = Game::Combat::Skill::Data::TrajectoryType::None; // 軌跡タイプ
		SkillTrajectory::TrajectoryParamsVariant trajectoryParams = Game::Combat::Skill::Data::SkillTrajectory::StaticTrajectory{}; // 軌跡パラメータ
	};
