...
//void Game::Combat::Skill::Trigger::PlayerSkillTriggerSystem::TriggerPlayerSkillsFromIntent(Engine::ECS::EntityMgr& ecs)
//{
//
...
//// 
////void Game::Combat::Skill::Trigger::PlayerSkillTriggerSystem::TriggerSkillsFromInput(Engine::ECS::EntityMgr& ecs, SkillInputMap& inputMap)
////{
////	for (Engine::ECS::Entity ePlayer : ecs.view<Engine::ECS::Component::Tags::PlayerControllerComponent, Game::Input::InputActionComponent, Game::Combat::Skill::Component::SkillSlotAssignmentComponent>())
////	{
////		const auto& input = ecs.get<Game::Input::InputActionComponent>(ePlayer);
////		auto& slotAssign = ecs.get<Game::Combat::Skill::Component::SkillSlotAssignmentComponent>(ePlayer);
////
